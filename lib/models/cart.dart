...
class Cart with ChangeNotifier{
  ...
  void addItem(String pdtid,String name,double price){
    if(_items.containsKey(pdtid)){
      _items.update(pdtid, (existingCartItem) => CartItem(name: existingCartItem.name, id: DateTime.now().toString(), quantity: existingCartItem.quantity+1, price:existingCartItem.price ));
    }
    else{
